...
const HeroSection = () => {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center min- h-screen text-center py-10 px-2 bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-black overflow-hidden border-3 border-slate-200 z-10">
            ...
            <div className="absolute -top-10 -left-10 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl -z-10"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl -z-10"></div>
            ...
            <div className="mt-10 flex gap-4">
                <Link
                    to="/all-posts"
                    className="flex items-center gap-2 px-3 py-2 md:px-6 md:py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-full shadow-lg transition-all"
                >
                    Start Reading <ArrowRight size={18} />
                </Link>
                <Link
                    to="/add-post"
                    className="px-3 py-2 md:px-6 md:py-3 border border-gray-400 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
                >
                    Write a Blog
                </Link>
            </div>
